...
RSpec.describe GameBoard do
    ...
    context "#get_ascending_diagonal_row" do 
        it "returns the row, starting from the coordinates of any square" do
            ...
            expect(@board.get_ascending_diagonal_row([0,0])).to eql(["X","X","O","X","X","X"])
        end

        it "same test as above with different starting position" do 
            expect(@board.get_ascending_diagonal_row([0,1])).to eql([" "," "," "," "," "," ",])
        end 
        ...
        it "returns a partially populated row" do 
            ...
            expect(@board.get_ascending_diagonal_row([0,0])).to eql([" ","O"," ","X"," ","O",])
        end
        ...
        it "handles an edge case where the initial square is near a corner" do 
            ...
            expect(@board.get_ascending_diagonal_row([4,0])).to eql(["X","O"])
        end
        ...
        it "handles an edge case where the initial square is near another corner" do 
            ...
            expect(@board.get_ascending_diagonal_row([0,5])).to eql(["X","O"])
        end
        ...
        it "handles an edge case where the starting square is in the middle of the board" do 
            ...
            expect(@board.get_ascending_diagonal_row([3,3])).to eql(["X","O","X"])
        end
    end
    ...
    it "returns the row, starting from the coordinates of any square" do
        ...
        expect(@board.get_descending_diagonal_row([5,1])).to eql(["X","X","X","O","X","X"])
    end

    it "same test as above with different starting position" do
         
        expect(@board.get_descending_diagonal_row([5,0])).to eql([" "," "," "," "," "," ",])
    end 
    ...
    it "returns a partially populated row" do 
        ...
        expect(@board.get_descending_diagonal_row([5,1])).to eql(["O"," ","X"," ","O"," ",])
    end
    ...
    it "handles an edge case where the initial square is near a corner" do 
        ...
        expect(@board.get_descending_diagonal_row([5,5])).to eql(["O","X"])
    end
    ...
    it "handles an edge case where the initial square is near another corner" do 
        ...
        expect(@board.get_descending_diagonal_row([1,0])).to eql(["O","X"])
    end
    ...
    it "handles an edge case where the starting square is in the middle of the board" do 
        ...
        expect(@board.get_descending_diagonal_row([3,3])).to eql(["X","O","X"," "])
    end
    end
